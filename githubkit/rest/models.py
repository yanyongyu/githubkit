...
class ScimUser(GitHubModel):
    ...
    emails: List["ScimUserPropEmailsItems"] = Field(
        description="user emails", min_items=1, default=...
    )
    ...
    operations: Union[Unset, List["ScimUserPropOperationsItems"]] = Field(
        description="Set of operations to be performed", min_items=1, default=UNSET
    )
...
class EnterprisesEnterpriseActionsRunnersRunnerIdLabelsPutResponse200(GitHubModel):
...
class ReposOwnerRepoIssuesIssueNumberLabelsPutBodyOneof2(GitHubModel):
    ...
    ] = Field(min_items=1, default=UNSET)
...
EnterprisesEnterpriseActionsRunnersRunnerIdLabelsPutResponse200.update_forward_refs()
