...
from .group_0306 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0307 import CodeScanningVariantAnalysisPropSkippedRepositories
