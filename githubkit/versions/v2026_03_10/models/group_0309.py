...
from .group_0310 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0311 import CodeScanningVariantAnalysisPropSkippedRepositories
