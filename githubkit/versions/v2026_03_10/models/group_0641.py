...
from .group_0649 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0650 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
