...
class WebhookRepositoryVulnerabilityAlertCreatePropAlert(GitHubModel):
    ...
    dismisser: Missing[
        Union[WebhookRepositoryVulnerabilityAlertCreatePropAlertPropDismisser, None]
...
class WebhookRepositoryVulnerabilityAlertCreatePropAlertPropDismisser(GitHubModel):
    """User"""
...
model_rebuild(WebhookRepositoryVulnerabilityAlertCreatePropAlertPropDismisser)
