...
from .group_0696 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0697 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
