...
from .group_0678 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0679 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
