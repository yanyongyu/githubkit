...
from .group_0258 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0259 import CodeScanningVariantAnalysisPropSkippedRepositories
