...
from .group_0672 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0673 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
