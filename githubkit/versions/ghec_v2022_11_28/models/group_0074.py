...
from .group_0072 import DependabotAlertSecurityVulnerability
from .group_0073 import DependabotAlertSecurityAdvisory
from .group_0075 import DependabotAlertWithRepositoryPropDependency
