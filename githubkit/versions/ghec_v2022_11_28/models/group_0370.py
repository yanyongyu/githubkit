...
from .group_0371 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0372 import CodeScanningVariantAnalysisPropSkippedRepositories
