...
from .group_0298 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0299 import CodeScanningVariantAnalysisPropSkippedRepositories
