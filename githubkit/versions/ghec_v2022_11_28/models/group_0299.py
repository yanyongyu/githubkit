...
from .group_0300 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0301 import CodeScanningVariantAnalysisPropSkippedRepositories
