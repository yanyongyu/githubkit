...
from .group_0348 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0349 import CodeScanningVariantAnalysisPropSkippedRepositories
