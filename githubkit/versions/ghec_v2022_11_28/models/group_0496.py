...
from .group_0504 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0505 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
