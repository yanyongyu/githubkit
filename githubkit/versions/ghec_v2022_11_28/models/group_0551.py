...
from .group_0559 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0560 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
