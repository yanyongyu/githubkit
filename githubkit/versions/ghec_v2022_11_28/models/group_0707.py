...
from .group_0715 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0716 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
