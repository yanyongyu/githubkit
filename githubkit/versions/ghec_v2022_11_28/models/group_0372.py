...
from .group_0373 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0374 import CodeScanningVariantAnalysisPropSkippedRepositories
