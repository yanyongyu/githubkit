...
from .group_0270 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0271 import CodeScanningVariantAnalysisPropSkippedRepositories
