...
class WebhookUserDeleted(GitHubModel):
    """WebhookUserDeleted"""
    ...
    user: Missing[Union[WebhookUserDeletedPropUser, None]] = Field(
        default=UNSET, title="User"
    )


class WebhookUserDeletedPropUser(GitHubModel):
    """User"""
...
model_rebuild(WebhookUserDeleted)
model_rebuild(WebhookUserDeletedPropUser)
