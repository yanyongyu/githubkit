...
from .group_0717 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0718 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
