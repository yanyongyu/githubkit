...
from .group_0717 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0718 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
