...
from .group_0387 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0388 import CodeScanningVariantAnalysisPropSkippedRepositories
