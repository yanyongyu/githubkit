...
from .group_0706 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0707 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
