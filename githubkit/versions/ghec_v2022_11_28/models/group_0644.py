...
from .group_0652 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0653 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
