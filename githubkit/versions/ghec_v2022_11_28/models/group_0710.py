...
from .group_0718 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0719 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
