...
from .group_0230 import CodeScanningVariantAnalysisPropSkippedRepositories
from .group_0229 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
