...
class WebhookUserCreated(GitHubModel):
    """WebhookUserCreated"""
    ...
    user: Missing[Union[WebhookUserCreatedPropUser, None]] = Field(
        default=UNSET, title="User"
    )


class WebhookUserCreatedPropUser(GitHubModel):
    """User"""
...
model_rebuild(WebhookUserCreated)
model_rebuild(WebhookUserCreatedPropUser)
