...
from .group_0307 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0308 import CodeScanningVariantAnalysisPropSkippedRepositories
