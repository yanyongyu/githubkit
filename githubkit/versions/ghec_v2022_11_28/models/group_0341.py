...
from .group_0342 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0343 import CodeScanningVariantAnalysisPropSkippedRepositories
