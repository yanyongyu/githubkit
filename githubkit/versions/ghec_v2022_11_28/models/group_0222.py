...
from .group_0224 import CodeScanningVariantAnalysisPropSkippedRepositories
from .group_0223 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
