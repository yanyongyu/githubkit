...
from .group_0564 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0565 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
