...
from .group_0704 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0705 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
