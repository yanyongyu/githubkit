...
from .group_0704 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0705 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
