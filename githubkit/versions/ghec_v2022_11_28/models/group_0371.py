...
from .group_0372 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0373 import CodeScanningVariantAnalysisPropSkippedRepositories
