...
from .group_0344 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0345 import CodeScanningVariantAnalysisPropSkippedRepositories
