...
from .group_0689 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0690 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
