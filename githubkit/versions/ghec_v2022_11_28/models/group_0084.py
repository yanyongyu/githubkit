...
from .group_0082 import DependabotAlertSecurityVulnerability
from .group_0083 import DependabotAlertSecurityAdvisory
from .group_0085 import DependabotAlertWithRepositoryPropDependency
