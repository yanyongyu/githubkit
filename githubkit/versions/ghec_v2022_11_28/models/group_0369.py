...
from .group_0370 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0371 import CodeScanningVariantAnalysisPropSkippedRepositories
