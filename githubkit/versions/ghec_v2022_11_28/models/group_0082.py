...
from .group_0080 import DependabotAlertSecurityVulnerability
from .group_0081 import DependabotAlertSecurityAdvisory
from .group_0083 import DependabotAlertWithRepositoryPropDependency
