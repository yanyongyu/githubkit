...
from .group_0087 import DependabotAlertSecurityVulnerability
from .group_0088 import DependabotAlertSecurityAdvisory
from .group_0090 import DependabotAlertWithRepositoryPropDependency
