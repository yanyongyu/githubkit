...
from .group_0705 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0706 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
