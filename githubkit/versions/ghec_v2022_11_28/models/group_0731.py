...
from .group_0739 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0740 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
