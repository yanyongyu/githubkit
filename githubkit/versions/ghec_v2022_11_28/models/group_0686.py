...
class WebhookRepositoryVulnerabilityAlertReopenPropAlert(GitHubModel):
    ...
    dismisser: Missing[
        Union[WebhookRepositoryVulnerabilityAlertReopenPropAlertPropDismisser, None]
...
class WebhookRepositoryVulnerabilityAlertReopenPropAlertPropDismisser(GitHubModel):
    """User"""
