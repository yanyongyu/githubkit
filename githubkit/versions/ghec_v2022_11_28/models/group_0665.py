...
from .group_0673 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0674 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
