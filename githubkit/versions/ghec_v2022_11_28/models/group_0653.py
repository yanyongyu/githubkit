...
from .group_0661 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0662 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
