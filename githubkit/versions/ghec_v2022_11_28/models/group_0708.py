...
from .group_0716 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0717 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
