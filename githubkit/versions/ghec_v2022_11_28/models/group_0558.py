...
from .group_0566 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0567 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
