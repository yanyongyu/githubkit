...
from .group_0662 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0663 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
