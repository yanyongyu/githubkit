...
from .group_0275 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0276 import CodeScanningVariantAnalysisPropSkippedRepositories
