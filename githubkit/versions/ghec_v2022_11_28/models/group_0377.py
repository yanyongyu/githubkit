...
from .group_0378 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0379 import CodeScanningVariantAnalysisPropSkippedRepositories
