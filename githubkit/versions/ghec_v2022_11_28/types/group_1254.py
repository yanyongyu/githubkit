...
class ReposOwnerRepoPatchBodyTypeForResponse(TypedDict):
    """ReposOwnerRepoPatchBody"""
    ...
    visibility: NotRequired[Literal["public", "private", "internal"]]
    security_and_analysis: NotRequired[
        Union[ReposOwnerRepoPatchBodyPropSecurityAndAnalysisTypeForResponse, None]
    ]
    has_issues: NotRequired[bool]
    has_projects: NotRequired[bool]
    has_wiki: NotRequired[bool]
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisTypeForResponse(TypedDict):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysis
    ...
    advanced_security: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropAdvancedSecurityTypeForResponse
    ]
    code_security: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropCodeSecurityTypeForResponse
    ]
    secret_scanning: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningTypeForResponse
    ]
    secret_scanning_push_protection: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningPushProtectionTypeForResponse
    ]
    secret_scanning_ai_detection: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningAiDetectionTypeForResponse
    ]
    secret_scanning_non_provider_patterns: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningNonProviderPatternsTypeForResponse
    ]
    secret_scanning_validity_checks: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningValidityChecksTypeForResponse
    ]
    secret_scanning_delegated_alert_dismissal: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedAlertDismissalTypeForResponse
    ]
    secret_scanning_delegated_bypass: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassTypeForResponse
    ]
    secret_scanning_delegated_bypass_options: NotRequired[
        ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassOptionsTypeForResponse
    ]
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropAdvancedSecurityTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropAdvancedSecurity
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropCodeSecurityTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropCodeSecurity
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanning
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningPushProtectionTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningPushProtection
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningAiDetectionType(
    ...
    secrets with AI](https://docs.github.com/enterprise-cloud@latest//code-
    security/secret-scanning/using-advanced-secret-scanning-and-push-protection-
    features/generic-secret-detection/responsible-ai-generic-secrets)."
    """

    status: NotRequired[str]


class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningAiDetectionTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningAiDetection
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningNonProviderPatternsTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningNonProviderPatte
    rns
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningValidityChecksTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningValidityChecks
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedAlertDismissalType(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedAlertDi
    smissal

    Use the `status` property to enable or disable secret scanning delegated alert
    dismissal for this repository.
    """

    status: NotRequired[str]


class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedAlertDismissalTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedAlertDi
    smissal
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassType(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypass

    Use the `status` property to enable or disable secret scanning delegated bypass
    for this repository.
    """
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypass
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassOptionsType(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassO
    ptions

    Feature options for secret scanning delegated bypass.
    This object is only honored when
    `security_and_analysis.secret_scanning_delegated_bypass.status` is set to
    `enabled`.
    You can send this object in the same request as
    `secret_scanning_delegated_bypass`, or update just the options in a separate
    request.
    """
...
class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassOptionsTypeForResponse(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassO
    ptions
    ...
    reviewers: NotRequired[
        list[
            ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassOptionsPropReviewersItemsTypeForResponse
        ]
    ]


class ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassOptionsPropReviewersItemsType(
    TypedDict
):
    """ReposOwnerRepoPatchBodyPropSecurityAndAnalysisPropSecretScanningDelegatedBypassO
    ptionsPropReviewersItems
    """
...
__all__ = (
    ...
    "ReposOwnerRepoPatchBodyPropSecurityAndAnalysisTypeForResponse",
    "ReposOwnerRepoPatchBodyType",
    "ReposOwnerRepoPatchBodyTypeForResponse",
)
