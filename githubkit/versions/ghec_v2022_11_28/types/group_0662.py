...
class WebhookReleaseUnpublishedPropReleaseType(TypedDict):
    ...
    assets: List[Union[WebhookReleaseUnpublishedPropReleasePropAssetsItemsType, None]]
    assets_url: str
    author: Union[WebhookReleaseUnpublishedPropReleasePropAuthorType, None]
    body: Union[str, None]
    ...
    reactions: NotRequired[WebhookReleaseUnpublishedPropReleasePropReactionsType]
    tag_name: str
...
class WebhookReleaseUnpublishedPropReleasePropAssetsItemsType(TypedDict):
    """Release Asset
    ...
    uploader: NotRequired[
        Union[WebhookReleaseUnpublishedPropReleasePropAssetsItemsPropUploaderType, None]
    ]
    url: str


class WebhookReleaseUnpublishedPropReleasePropAssetsItemsPropUploaderType(TypedDict):
    """User"""
...
class WebhookReleaseUnpublishedPropReleasePropAuthorType(TypedDict):
    """User"""
...
class WebhookReleaseUnpublishedPropReleasePropReactionsType(TypedDict):
    """Reactions"""
