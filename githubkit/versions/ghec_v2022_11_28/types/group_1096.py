...
class InstallationRepositoriesGetResponse200Type(TypedDict):
    ...
    total_count: int
    repositories: list[InstallationRepositoriesGetResponse200PropRepositoriesItemsType]
...
class InstallationRepositoriesGetResponse200TypeForResponse(TypedDict):
    ...
    total_count: int
    repositories: list[
        InstallationRepositoriesGetResponse200PropRepositoriesItemsTypeForResponse
    ]
    repository_selection: NotRequired[str]
