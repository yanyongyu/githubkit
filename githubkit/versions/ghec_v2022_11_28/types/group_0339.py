...
from .group_0080 import DependabotAlertSecurityVulnerabilityType
from .group_0081 import DependabotAlertSecurityAdvisoryType
from .group_0340 import DependabotAlertPropDependencyType
