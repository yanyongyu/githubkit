...
from .group_0258 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0259 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
