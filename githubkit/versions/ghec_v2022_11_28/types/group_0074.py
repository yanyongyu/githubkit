...
from .group_0072 import DependabotAlertSecurityVulnerabilityType
from .group_0073 import DependabotAlertSecurityAdvisoryType
from .group_0075 import DependabotAlertWithRepositoryPropDependencyType
