...
from .group_0551 import WebhookIssuesLockedPropIssueMergedMilestoneType
from .group_0549 import WebhookIssuesLockedPropIssueAllof0PropPullRequestType
from .group_0552 import WebhookIssuesLockedPropIssueMergedPerformedViaGithubAppType
