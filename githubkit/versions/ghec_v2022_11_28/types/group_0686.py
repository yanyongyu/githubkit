...
class WebhookRepositoryVulnerabilityAlertReopenPropAlertType(TypedDict):
    ...
    dismisser: NotRequired[
        Union[WebhookRepositoryVulnerabilityAlertReopenPropAlertPropDismisserType, None]
    ]
...
class WebhookRepositoryVulnerabilityAlertReopenPropAlertPropDismisserType(TypedDict):
    """User"""
