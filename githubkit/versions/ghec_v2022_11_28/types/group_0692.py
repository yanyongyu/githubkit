...
from .group_0700 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0701 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
