...
from .group_0344 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0345 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
