...
from .group_0307 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0308 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
