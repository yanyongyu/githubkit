...
from .group_0528 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0529 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
