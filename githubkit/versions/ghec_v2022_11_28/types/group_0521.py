...
from .group_0529 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0530 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
