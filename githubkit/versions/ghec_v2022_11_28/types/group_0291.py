...
from .group_0292 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0293 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
