...
from .group_0655 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0656 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
