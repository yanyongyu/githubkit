...
from .group_0288 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0289 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
