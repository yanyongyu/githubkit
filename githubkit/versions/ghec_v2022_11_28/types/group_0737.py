...
from .group_0740 import WebhookRepositoryRulesetEditedPropChangesPropRulesType
from .group_0738 import WebhookRepositoryRulesetEditedPropChangesPropConditionsType
