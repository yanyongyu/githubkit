...
from .group_0742 import WebhookRepositoryRulesetEditedPropChangesPropRulesType
from .group_0740 import WebhookRepositoryRulesetEditedPropChangesPropConditionsType
