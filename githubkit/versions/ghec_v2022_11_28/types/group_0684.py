...
class WebhookRepositoryVulnerabilityAlertCreatePropAlertType(TypedDict):
    ...
    dismisser: NotRequired[
        Union[WebhookRepositoryVulnerabilityAlertCreatePropAlertPropDismisserType, None]
    ]
...
class WebhookRepositoryVulnerabilityAlertCreatePropAlertPropDismisserType(TypedDict):
    """User"""
