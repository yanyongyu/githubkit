...
from .group_0075 import DependabotAlertSecurityVulnerabilityType
from .group_0076 import DependabotAlertSecurityAdvisoryType
from .group_0333 import DependabotAlertPropDependencyType
