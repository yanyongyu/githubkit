...
class WebhookReleasePublishedPropReleaseType(TypedDict):
    ...
    assets: List[Union[WebhookReleasePublishedPropReleasePropAssetsItemsType, None]]
    assets_url: str
    author: Union[WebhookReleasePublishedPropReleasePropAuthorType, None]
    body: Union[str, None]
    ...
    reactions: NotRequired[WebhookReleasePublishedPropReleasePropReactionsType]
    tag_name: str
...
class WebhookReleasePublishedPropReleasePropAssetsItemsType(TypedDict):
    """Release Asset
    ...
    uploader: NotRequired[
        Union[WebhookReleasePublishedPropReleasePropAssetsItemsPropUploaderType, None]
    ]
    url: str


class WebhookReleasePublishedPropReleasePropAssetsItemsPropUploaderType(TypedDict):
    """User"""
...
class WebhookReleasePublishedPropReleasePropAuthorType(TypedDict):
    """User"""
...
class WebhookReleasePublishedPropReleasePropReactionsType(TypedDict):
    """Reactions"""
