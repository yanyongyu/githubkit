...
from .group_0237 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0238 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
