...
from .group_0222 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0223 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
