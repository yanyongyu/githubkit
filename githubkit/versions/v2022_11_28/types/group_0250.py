...
from .group_0251 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
from .group_0252 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
