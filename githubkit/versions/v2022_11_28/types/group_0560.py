...
from .group_0563 import WebhookIssueCommentEditedPropIssueAllof0PropMilestoneType
from .group_0565 import (
    WebhookIssueCommentEditedPropIssueAllof0PropPerformedViaGithubAppType,
)
from .group_0566 import WebhookIssueCommentEditedPropIssueAllof0PropSubIssuesSummaryType
