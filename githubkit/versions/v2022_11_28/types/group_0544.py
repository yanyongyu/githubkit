...
from .group_0547 import WebhookIssueCommentEditedPropIssueAllof0PropMilestoneType
from .group_0549 import (
    WebhookIssueCommentEditedPropIssueAllof0PropPerformedViaGithubAppType,
)
from .group_0550 import WebhookIssueCommentEditedPropIssueAllof0PropSubIssuesSummaryType
