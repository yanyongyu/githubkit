...
from .group_0720 import WebhookRepositoryRulesetEditedPropChangesPropConditionsType
from .group_0722 import WebhookRepositoryRulesetEditedPropChangesPropRulesType
