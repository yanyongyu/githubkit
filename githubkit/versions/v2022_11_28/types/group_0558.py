...
from .group_0560 import WebhookIssuesClosedPropIssueAllof0PropMilestoneType
from .group_0562 import WebhookIssuesClosedPropIssueAllof0PropPerformedViaGithubAppType
