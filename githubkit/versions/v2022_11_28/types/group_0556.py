...
from .group_0564 import WebhookIssuesClosedPropIssueMergedMilestoneType
from .group_0565 import WebhookIssuesClosedPropIssueMergedPerformedViaGithubAppType
