...
from .group_0705 import WebhookRepositoryRulesetEditedPropChangesPropRulesType
from .group_0703 import WebhookRepositoryRulesetEditedPropChangesPropConditionsType
