...
from .group_0219 import CodeScanningVariantAnalysisPropSkippedRepositoriesType
from .group_0218 import CodeScanningVariantAnalysisPropScannedRepositoriesItemsType
