...
from .group_0716 import WebhookRepositoryRulesetEditedPropChangesPropConditionsType
from .group_0718 import WebhookRepositoryRulesetEditedPropChangesPropRulesType
