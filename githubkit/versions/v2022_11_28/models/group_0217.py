...
from .group_0219 import CodeScanningVariantAnalysisPropSkippedRepositories
from .group_0218 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
