...
from .group_0226 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0227 import CodeScanningVariantAnalysisPropSkippedRepositories
