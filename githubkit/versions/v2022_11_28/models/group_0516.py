...
from .group_0524 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0525 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
