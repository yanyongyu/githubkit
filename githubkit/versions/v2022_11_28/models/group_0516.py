...
from .group_0524 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0525 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
