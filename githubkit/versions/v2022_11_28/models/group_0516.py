...
class WebhookMarketplacePurchaseCancelledPropMarketplacePurchase(GitHubModel):
    ...
    account: WebhookMarketplacePurchaseCancelledPropMarketplacePurchasePropAccount = (
        Field()
    )
    ...
    plan: WebhookMarketplacePurchaseCancelledPropMarketplacePurchasePropPlan = Field()
    unit_count: int = Field()


class WebhookMarketplacePurchaseCancelledPropMarketplacePurchasePropAccount(
    GitHubModel
):
...
class WebhookMarketplacePurchaseCancelledPropMarketplacePurchasePropPlan(GitHubModel):
...
model_rebuild(WebhookMarketplacePurchaseCancelledPropMarketplacePurchasePropAccount)
