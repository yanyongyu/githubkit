...
from .group_0209 import CodeScanningVariantAnalysisPropSkippedRepositories
from .group_0208 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
