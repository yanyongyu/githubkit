...
from .group_0529 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0530 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
