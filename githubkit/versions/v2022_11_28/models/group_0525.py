...
from .group_0533 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0534 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
