...
from .group_0535 import WebhookIssueCommentDeletedPropIssueAllof0PropMilestone
from .group_0537 import (
    WebhookIssueCommentDeletedPropIssueAllof0PropPerformedViaGithubApp,
)
from .group_0538 import WebhookIssueCommentDeletedPropIssueAllof0PropSubIssuesSummary
