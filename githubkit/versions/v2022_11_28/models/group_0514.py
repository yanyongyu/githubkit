...
from .group_0522 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0523 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
