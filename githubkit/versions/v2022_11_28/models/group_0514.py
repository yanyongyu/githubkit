...
from .group_0522 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0523 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
