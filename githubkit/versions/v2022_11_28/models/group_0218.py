...
from .group_0219 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0220 import CodeScanningVariantAnalysisPropSkippedRepositories
