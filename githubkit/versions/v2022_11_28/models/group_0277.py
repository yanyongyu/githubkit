...
from .group_0278 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0279 import CodeScanningVariantAnalysisPropSkippedRepositories
