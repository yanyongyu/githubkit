...
from .group_0527 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0528 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
