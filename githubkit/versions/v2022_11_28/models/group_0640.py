...
from .group_0648 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0649 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
