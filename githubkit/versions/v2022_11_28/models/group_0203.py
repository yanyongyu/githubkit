...
from .group_0205 import CodeScanningVariantAnalysisPropSkippedRepositories
from .group_0204 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
