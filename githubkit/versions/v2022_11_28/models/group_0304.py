...
from .group_0305 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0306 import CodeScanningVariantAnalysisPropSkippedRepositories
