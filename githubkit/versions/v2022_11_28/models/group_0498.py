...
from .group_0506 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0507 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
