...
from .group_0605 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0606 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
