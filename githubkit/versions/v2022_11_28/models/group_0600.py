...
from .group_0608 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0609 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
