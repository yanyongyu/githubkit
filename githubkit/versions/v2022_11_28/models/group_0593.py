...
from .group_0601 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0602 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
