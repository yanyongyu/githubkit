...
from .group_0220 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0221 import CodeScanningVariantAnalysisPropSkippedRepositories
