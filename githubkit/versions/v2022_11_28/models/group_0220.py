...
from .group_0221 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0222 import CodeScanningVariantAnalysisPropSkippedRepositories
