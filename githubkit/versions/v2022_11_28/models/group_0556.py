...
from .group_0565 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0566 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
