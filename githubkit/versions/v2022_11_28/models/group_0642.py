...
from .group_0650 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0651 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
