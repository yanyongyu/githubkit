...
from .group_0247 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0248 import CodeScanningVariantAnalysisPropSkippedRepositories
