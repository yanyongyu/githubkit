...
from .group_0246 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0247 import CodeScanningVariantAnalysisPropSkippedRepositories
