...
from .group_0302 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0303 import CodeScanningVariantAnalysisPropSkippedRepositories
