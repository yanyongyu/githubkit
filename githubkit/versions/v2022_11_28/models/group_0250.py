...
from .group_0251 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0252 import CodeScanningVariantAnalysisPropSkippedRepositories
