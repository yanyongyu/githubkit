...
from .group_0303 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0304 import CodeScanningVariantAnalysisPropSkippedRepositories
