...
from .group_0523 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0524 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
