...
from .group_0546 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0547 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
