...
from .group_0222 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0223 import CodeScanningVariantAnalysisPropSkippedRepositories
