...
from .group_0471 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0472 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
