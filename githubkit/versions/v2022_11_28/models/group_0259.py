...
from .group_0260 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0261 import CodeScanningVariantAnalysisPropSkippedRepositories
