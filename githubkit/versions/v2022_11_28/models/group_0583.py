...
from .group_0591 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0592 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
