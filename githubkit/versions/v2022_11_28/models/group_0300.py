...
from .group_0301 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0302 import CodeScanningVariantAnalysisPropSkippedRepositories
