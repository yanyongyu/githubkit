...
from .group_0381 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0382 import CodeScanningVariantAnalysisPropSkippedRepositories
