...
from .group_0379 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0380 import CodeScanningVariantAnalysisPropSkippedRepositories
