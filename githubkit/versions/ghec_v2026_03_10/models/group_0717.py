...
from .group_0725 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0726 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
