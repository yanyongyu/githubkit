...
from .group_0736 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0737 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
