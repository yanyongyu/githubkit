...
from .group_0648 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0649 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
