...
from .group_0654 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0655 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
