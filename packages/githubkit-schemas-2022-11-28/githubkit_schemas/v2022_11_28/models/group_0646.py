...
from .group_0654 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0655 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
