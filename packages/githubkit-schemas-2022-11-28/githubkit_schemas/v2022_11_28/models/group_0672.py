...
from .group_0680 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0681 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
