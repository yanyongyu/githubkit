...
from .group_0330 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0331 import CodeScanningVariantAnalysisPropSkippedRepositories
