...
from .group_0327 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0328 import CodeScanningVariantAnalysisPropSkippedRepositories
