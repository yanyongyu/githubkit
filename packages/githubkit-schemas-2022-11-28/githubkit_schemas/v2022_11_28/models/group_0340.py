...
from .group_0341 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0342 import CodeScanningVariantAnalysisPropSkippedRepositories
