...
from .group_0718 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0719 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
