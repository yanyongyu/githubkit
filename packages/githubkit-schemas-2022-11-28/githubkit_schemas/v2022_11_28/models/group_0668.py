...
from .group_0676 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0677 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
