...
from .group_0705 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0706 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
