...
from .group_0672 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0673 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
