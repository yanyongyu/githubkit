...
from .group_0364 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0365 import CodeScanningVariantAnalysisPropSkippedRepositories
