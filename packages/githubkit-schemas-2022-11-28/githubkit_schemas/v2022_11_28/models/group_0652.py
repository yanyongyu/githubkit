...
from .group_0660 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0661 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
