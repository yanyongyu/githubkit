...
from .group_0316 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0317 import CodeScanningVariantAnalysisPropSkippedRepositories
