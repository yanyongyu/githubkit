...
from .group_0694 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0695 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
