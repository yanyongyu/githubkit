...
from .group_0671 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0672 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
