...
from .group_0665 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0666 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
