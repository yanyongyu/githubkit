...
class WebhookNamespace:
    ...
    @staticmethod
    def parse(
        name: Literal["exemption_request_secret_scanning"], payload: str | bytes
    ...
    @staticmethod
    def parse(
        name: Literal["dismissal_request_code_scanning"], payload: str | bytes
    ) -> "DismissalRequestCodeScanningEvent": ...
    @overload
    @staticmethod
    def parse(
        name: Literal["dismissal_request_dependabot"], payload: str | bytes
    ) -> "DismissalRequestDependabotEvent": ...
    @overload
    @staticmethod
    def parse(
        name: Literal["dismissal_request_secret_scanning"], payload: str | bytes
    ) -> "DismissalRequestSecretScanningEvent": ...
    @overload
    @staticmethod
    def parse(
        name: Literal["exemption_request_push_ruleset"], payload: str | bytes
    ...
    @staticmethod
    def parse(
        name: Literal["organization_custom_property"], payload: str | bytes
    ) -> "OrganizationCustomPropertyEvent": ...
    @overload
    @staticmethod
    def parse(
        name: Literal["organization_custom_property_values"], payload: str | bytes
    ) -> "OrganizationCustomPropertyValuesEvent": ...
    @overload
    @staticmethod
    def parse(
