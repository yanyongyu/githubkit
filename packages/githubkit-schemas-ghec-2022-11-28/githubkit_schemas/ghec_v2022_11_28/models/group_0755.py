...
from .group_0763 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0764 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
