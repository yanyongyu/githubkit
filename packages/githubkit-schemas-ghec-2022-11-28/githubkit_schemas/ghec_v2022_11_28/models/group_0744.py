...
from .group_0752 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0753 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
