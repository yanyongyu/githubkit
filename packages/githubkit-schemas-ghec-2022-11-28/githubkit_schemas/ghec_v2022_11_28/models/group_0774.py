...
from .group_0782 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0783 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
