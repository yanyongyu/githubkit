...
from .group_0396 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0397 import CodeScanningVariantAnalysisPropSkippedRepositories
