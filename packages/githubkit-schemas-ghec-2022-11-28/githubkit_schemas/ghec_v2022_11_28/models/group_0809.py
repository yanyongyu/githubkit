...
from .group_0817 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0818 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
