...
from .group_0743 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0744 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentEditedPropIssue(GitHubModel):
    ...
    assignee: Union[WebhookIssueCommentEditedPropIssueAllof0PropAssignee, None] = Field(
        title="User"
    )
