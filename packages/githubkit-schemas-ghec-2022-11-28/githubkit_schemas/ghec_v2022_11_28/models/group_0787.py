...
from .group_0795 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0796 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
