...
from .group_0794 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0795 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
