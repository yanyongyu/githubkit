...
from .group_0772 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0773 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
