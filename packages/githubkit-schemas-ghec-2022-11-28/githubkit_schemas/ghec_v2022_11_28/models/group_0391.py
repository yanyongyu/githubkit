...
from .group_0392 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0393 import CodeScanningVariantAnalysisPropSkippedRepositories
