...
from .group_0732 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0733 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentDeletedPropIssue(GitHubModel):
    ...
    assignee: Union[WebhookIssueCommentDeletedPropIssueAllof0PropAssignee, None] = (
        Field(title="User")
    )
