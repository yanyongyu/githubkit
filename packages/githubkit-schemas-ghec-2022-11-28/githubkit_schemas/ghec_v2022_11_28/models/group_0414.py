...
from .group_0415 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0416 import CodeScanningVariantAnalysisPropSkippedRepositories
