...
from .group_0765 import WebhookIssueCommentUnpinnedPropIssueMergedMilestone
from .group_0766 import WebhookIssueCommentUnpinnedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentUnpinnedPropIssue(GitHubModel):
    ...
    assignee: Union[WebhookIssueCommentUnpinnedPropIssueAllof0PropAssignee, None] = (
        Field(title="User")
    )
