...
from .group_0400 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0401 import CodeScanningVariantAnalysisPropSkippedRepositories
