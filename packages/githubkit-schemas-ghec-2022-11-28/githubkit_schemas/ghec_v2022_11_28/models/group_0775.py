...
from .group_0783 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0784 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
