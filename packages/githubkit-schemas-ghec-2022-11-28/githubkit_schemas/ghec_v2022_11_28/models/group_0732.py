...
from .group_0740 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0741 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
