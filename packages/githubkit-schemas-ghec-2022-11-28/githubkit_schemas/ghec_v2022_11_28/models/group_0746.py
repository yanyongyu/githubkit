...
from .group_0754 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0755 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentPinnedPropIssue(GitHubModel):
    ...
    assignee: Union[WebhookIssueCommentPinnedPropIssueAllof0PropAssignee, None] = Field(
        title="User"
    )
