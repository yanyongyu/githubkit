...
from .group_0393 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0394 import CodeScanningVariantAnalysisPropSkippedRepositories
