...
from .group_0416 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0417 import CodeScanningVariantAnalysisPropSkippedRepositories
