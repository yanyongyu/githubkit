...
class ReposClient:
    ...
    def get_repo_push_bypass_request(
        ...
        *,
        headers: Mapping[str, str] | None = None,
        stream: bool = False,
    ) -> Response[PushRuleBypassRequest, PushRuleBypassRequestTypeForResponse]:
    ...
    def list_issue_types(
        ...
        *,
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/repos/issue-types#list-issue-types-for-a-repository
        """
