...
class AgentTasksClient:
    ...
    def list_tasks_for_repo(
        ...
        * "Agent tasks" repository permissions (read)
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/agent-tasks/agent-tasks#list-tasks-for-repository
        """
    ...
    def create_task_in_repo(
        ...
        * "Agent tasks" repository permissions (read and write)
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/agent-tasks/agent-tasks#start-a-task
        """
    ...
    @overload
    async def async_create_task_in_repo(
        self,
        owner: str,
        repo: str,
        *,
    ...
    def get_task_by_repo_and_id(
        ...
        * "Agent tasks" repository permissions (read)
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/agent-tasks/agent-tasks#get-a-task-by-repo
        """
    ...
    def list_tasks(
        ...
        * "Agent tasks" repository permissions (read)
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/agent-tasks/agent-tasks#list-tasks
        """
    ...
    def get_task_by_id(
        ...
        * "Agent tasks" repository permissions (read)
        ...
        See also: https://docs.github.com/enterprise-cloud@latest/rest/agent-tasks/agent-tasks#get-a-task-by-id
        """
