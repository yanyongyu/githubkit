...
from .group_0794 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0795 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
