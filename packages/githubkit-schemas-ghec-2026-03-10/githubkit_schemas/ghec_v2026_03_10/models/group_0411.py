...
from .group_0412 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0413 import CodeScanningVariantAnalysisPropSkippedRepositories
