...
from .group_0796 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0797 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
