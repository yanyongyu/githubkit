...
from .group_0731 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0732 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
