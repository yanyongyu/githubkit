...
from .group_0385 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0386 import CodeScanningVariantAnalysisPropSkippedRepositories
