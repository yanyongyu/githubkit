...
from .group_0394 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0395 import CodeScanningVariantAnalysisPropSkippedRepositories
