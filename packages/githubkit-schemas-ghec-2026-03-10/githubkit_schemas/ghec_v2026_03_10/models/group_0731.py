...
from .group_0739 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0740 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
