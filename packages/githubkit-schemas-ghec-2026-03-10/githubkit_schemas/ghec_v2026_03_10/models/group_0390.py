...
from .group_0391 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0392 import CodeScanningVariantAnalysisPropSkippedRepositories
