...
from .group_0781 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0782 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
