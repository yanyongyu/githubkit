...
from .group_0771 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0772 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
