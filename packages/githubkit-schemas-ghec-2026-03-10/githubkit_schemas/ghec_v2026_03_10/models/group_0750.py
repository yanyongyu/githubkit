...
from .group_0758 import WebhookIssueCommentPinnedPropIssueMergedMilestone
from .group_0759 import WebhookIssueCommentPinnedPropIssueMergedPerformedViaGithubApp
