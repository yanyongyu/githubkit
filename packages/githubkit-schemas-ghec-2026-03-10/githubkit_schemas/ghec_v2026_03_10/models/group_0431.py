...
from .group_0432 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0433 import CodeScanningVariantAnalysisPropSkippedRepositories
