...
from .group_0792 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0793 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
