...
from .group_0720 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0721 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
...
class WebhookIssueCommentCreatedPropIssue(GitHubModel):
    ...
    assignee: Union[WebhookIssueCommentCreatedPropIssueAllof0PropAssignee, None] = (
        Field(title="User")
    )
