...
from .group_0398 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0399 import CodeScanningVariantAnalysisPropSkippedRepositories
