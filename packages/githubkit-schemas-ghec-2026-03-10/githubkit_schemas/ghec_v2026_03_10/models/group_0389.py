...
from .group_0390 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0391 import CodeScanningVariantAnalysisPropSkippedRepositories
