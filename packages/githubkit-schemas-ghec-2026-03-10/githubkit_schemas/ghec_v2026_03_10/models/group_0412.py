...
from .group_0413 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0414 import CodeScanningVariantAnalysisPropSkippedRepositories
