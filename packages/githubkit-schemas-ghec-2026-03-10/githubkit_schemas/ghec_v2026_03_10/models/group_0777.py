...
from .group_0785 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0786 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
