...
from .group_0622 import WebhooksSponsorshipType, WebhooksSponsorshipTypeForResponse
from .group_0623 import WebhooksChanges8Type, WebhooksChanges8TypeForResponse
