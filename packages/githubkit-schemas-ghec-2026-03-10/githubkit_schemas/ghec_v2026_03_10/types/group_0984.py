...
from .group_0614 import WebhooksSponsorshipType, WebhooksSponsorshipTypeForResponse
from .group_0615 import WebhooksChanges8Type, WebhooksChanges8TypeForResponse
