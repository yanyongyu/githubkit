...
from .group_0648 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0649 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
