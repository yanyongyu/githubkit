...
from .group_0328 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0329 import CodeScanningVariantAnalysisPropSkippedRepositories
