...
from .group_0706 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0707 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
