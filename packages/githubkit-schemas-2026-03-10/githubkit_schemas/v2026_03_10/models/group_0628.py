...
from .group_0636 import WebhookIssueCommentCreatedPropIssueMergedMilestone
from .group_0637 import WebhookIssueCommentCreatedPropIssueMergedPerformedViaGithubApp
