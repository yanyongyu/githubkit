...
from .group_0679 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0680 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
