...
from .group_0695 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0696 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
