...
from .group_0332 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0333 import CodeScanningVariantAnalysisPropSkippedRepositories
