...
from .group_0659 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0660 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
