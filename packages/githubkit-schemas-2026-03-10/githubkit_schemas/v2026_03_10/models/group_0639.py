...
from .group_0647 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0648 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
