...
from .group_0671 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0672 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
