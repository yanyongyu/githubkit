...
from .group_0340 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0341 import CodeScanningVariantAnalysisPropSkippedRepositories
