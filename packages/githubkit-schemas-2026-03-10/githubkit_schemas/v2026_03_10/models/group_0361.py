...
from .group_0362 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0363 import CodeScanningVariantAnalysisPropSkippedRepositories
