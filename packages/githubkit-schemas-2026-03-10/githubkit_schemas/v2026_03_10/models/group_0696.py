...
from .group_0704 import WebhookIssueCommentDeletedPropIssueMergedMilestone
from .group_0705 import WebhookIssueCommentDeletedPropIssueMergedPerformedViaGithubApp
