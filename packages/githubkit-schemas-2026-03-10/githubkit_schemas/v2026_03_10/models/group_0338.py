...
from .group_0339 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0340 import CodeScanningVariantAnalysisPropSkippedRepositories
