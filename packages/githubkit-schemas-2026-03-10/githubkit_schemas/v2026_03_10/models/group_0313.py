...
from .group_0314 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0315 import CodeScanningVariantAnalysisPropSkippedRepositories
