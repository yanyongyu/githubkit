...
from .group_0474 import SecretScanningAlertMetadataItems


class SecretScanningAlertWithMetadata(GitHubModel):
...
model_rebuild(SecretScanningAlertWithMetadata)

__all__ = ("SecretScanningAlertWithMetadata",)
