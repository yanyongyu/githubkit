...
from .group_0670 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0671 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
