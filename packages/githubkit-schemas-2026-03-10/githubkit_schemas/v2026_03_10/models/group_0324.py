...
from .group_0325 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0326 import CodeScanningVariantAnalysisPropSkippedRepositories
