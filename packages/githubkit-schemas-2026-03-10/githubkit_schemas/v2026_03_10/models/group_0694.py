...
from .group_0702 import WebhookIssueCommentEditedPropIssueMergedMilestone
from .group_0703 import WebhookIssueCommentEditedPropIssueMergedPerformedViaGithubApp
