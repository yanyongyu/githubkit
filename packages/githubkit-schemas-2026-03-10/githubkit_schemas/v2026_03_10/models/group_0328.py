...
from .group_0329 import CodeScanningVariantAnalysisPropScannedRepositoriesItems
from .group_0330 import CodeScanningVariantAnalysisPropSkippedRepositories
